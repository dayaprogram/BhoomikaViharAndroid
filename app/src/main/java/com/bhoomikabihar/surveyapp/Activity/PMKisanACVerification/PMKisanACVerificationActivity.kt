...
import com.bhoomikabihar.surveyapp.Activity.VerifyFarmer.ui.VerificationFragments.PMKisanACVerificationFragment
import com.bhoomikabihar.surveyapp.Model.FarmerRegDetails
import com.bhoomikabihar.surveyapp.R


class PMKisanACVerificationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            supportFragmentManager.beginTransaction()
                .replace(R.id.container, PMKisanACVerificationFragment.newInstance())
                .commitNow()
        }
    }
