...
import com.bhoomikabihar.surveyapp.Activity.VerifyFarmer.ui.VerificationFragments.PMKisanADMVerificationFragment
import com.bhoomikabihar.surveyapp.Model.FarmerRegDetails
import com.bhoomikabihar.surveyapp.R


class PMKisanADMVerificationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = PMKisanACVerificationViewModel(application)
        ...
        if (savedInstanceState == null) {
            supportFragmentManager.beginTransaction()
                .replace(R.id.container, PMKisanADMVerificationFragment.newInstance())
                .commitNow()
        }
    }
