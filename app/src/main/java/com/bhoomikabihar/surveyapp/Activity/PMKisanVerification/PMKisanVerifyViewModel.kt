...
import com.bhoomikabihar.surveyapp.Model.SpinnerObj

class PMKisanVerifyViewModel(application: Application) : AndroidViewModel(application) {
...
//        get() = _farmerFamily
    ...
    fun getUnVerifiedPMKisanList() {
        remoteRepository?.getUnVerifiedPMKisanList()!!
        remoteRepository?.liveUnVerifiedFarmerList!!.observeForever { result ->
    ...
    fun saveApprovedFarmerDetails(farmerVerifyData: PMKisanEligibleVerification) {
        remoteRepository?.saveVerifiedPMKisanFarmerDetails(farmerVerifyData)!!
