...
public class FarmerCallListAdaptor(
    mCtx: Context,
    farmerList: List<FarmerRegDetails>,
    recyclerViewClickInterface: RecyclerViewClickInterfaceVerifyFarmer
) : RecyclerView.Adapter<FarmerCallListAdaptor.DashboardMenuViewHolder>(), Filterable {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DashboardMenuViewHolder {
        ...
        val view: View = inflater.inflate(R.layout.layout_farmer_call_list, null)
    ...
    inner class DashboardMenuViewHolder(
        ...
        init {
            ...
            viewsLayout = itemView.findViewById(R.id.farmerCallListLayout)
