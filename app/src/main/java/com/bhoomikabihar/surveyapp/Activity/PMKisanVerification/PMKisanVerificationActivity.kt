...
import com.bhoomikabihar.surveyapp.Activity.VerifyFarmer.ui.VerificationFragments.PMKisanVerificationFragment
import com.bhoomikabihar.surveyapp.Model.FarmerRegDetails
import com.bhoomikabihar.surveyapp.R


class PMKisanVerificationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = PMKisanVerifyViewModel(application)
        ...
        if (savedInstanceState == null) {
            supportFragmentManager.beginTransaction()
                .replace(R.id.container, PMKisanVerificationFragment.newInstance())
                .commitNow()
        }
    }
